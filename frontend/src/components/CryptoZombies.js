...
const address = "0xaf3222a1ddc34c21c700C006e05e16AB4284362f";
// custom+ end
...
function CryptoZombies() { 
  ...
  function createRandomZombie(name) {
    console.log("createRandomZombie");
    ...
    cryptoZombies.deployed().then(function(instance){
      return instance.createRandomZombie(name, { from: account });
    }).then(function(receipt){
      console.log("Successfully created " + name + "!");
  
      // Transaction was accepted into the blockchain, let's redraw the UI
      // getZombiesByOwner(account).then(displayZombies); 
    }).catch(function(err) {
